...
const titles = ["Design Her.", "Talk Freely.", "Come Back Anytime."];
    ...
    <section id="how" className="bg-background">
      <div ref={sectionRef} className="relative" style={{ height: "200vh" }}>
        <div className="sticky top-0 h-screen flex items-center justify-center overflow-hidden">
          <div className="relative w-full max-w-7xl px-4">
            <div className="flex items-center justify-center pointer-events-none" style={{ perspective: "1000px" }}>
              <div className="relative w-full" style={{ transformStyle: "preserve-3d", minHeight: "150px" }}>
                {titles.map((title, index) => {
                  ...
                  return (
                    <h2
                      key={index}
                      className="absolute inset-0 flex items-center justify-center romance-title text-[10vw] sm:text-[7vw] leading-tight tracking-tighter text-rose-50 md:text-[6vw] lg:text-[5vw] text-center px-4"
                      style={{
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          <p className="mt-8 leading-relaxed text-2xl md:text-3xl text-rose-100/85 max-w-5xl mx-auto">
            {(
              "Choose how she sounds. How she speaks. How she makes you feel. No judgement. No pressure. Just your voice and hers, in one soft conversation."
            )
              .split(" ")
          ...
          <p className="mt-8 inline-flex soft-pill px-4 py-2 text-sm font-semibold text-[#F4C430]">
